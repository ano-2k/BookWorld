...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        "name" => "Throne of Glass: Throne of Glass, Book 1",
        "price" => 32.00,
        "quantity" => (int)$_POST['quantity'],
        "image" => "Images/pro-08.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>Throne of Glass: Throne of Glass,Book 1 - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-08.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>Throne of Glass: Throne of Glass, Book 1</h2>
                <h4>Sarah J. Maas (Author), Elizabeth Evans (Narrator), Bloomsbury Publishing Plc (Publisher)</h4>
                <p><br>Bloomsbury presents Throne of Glass by Sarah J. Maas, read by Elizabeth Evans.<br>Enter the world of Throne of Glass with the first book in the #1 bestselling series by Sarah J. Maas.<br>Thrilling and fierce, Throne of Glass is the first book in the #1 New York Times bestselling series that has captivated listeners worldwide.</p>
                <h3>$32.00</h3>
                <form method="POST">
