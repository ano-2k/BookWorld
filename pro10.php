...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        ...
        "image" => "Images/pro-10.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>Dianetics: The Modern Science of Mental Health - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-10.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>Dianetics: The Modern Science of Mental Health</h2>
                <h4>by L. Ron Hubbard (Author)</h4>
                <p><br>The #1 New York Times bestseller<br>“[Dianetics is] a new science which works with the invariability of physical science in the field of the human mind. From all indications it will prove to be as revolutionary for humanity as the first caveman’s discovery and utilization of fire.” (Daily Mirror)</p>
                <h3>$14.00</h3>
                <form method="POST">
