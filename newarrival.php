...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        "name" => "A Calamity of Souls Kindle Edition",
        "price" => 15.00,
        "quantity" => (int)$_POST['quantity'],
        "image" => "Images/exclusive.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>A Calamity of Souls Kindle Edition - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/exclusive.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>A Calamity of Souls Kindle Edition</h2>
                <h4>by David Baldacci (Author) | Format: Kindle Edition</h4>
                <p><br>#1 Best Seller in Suspense Action Fiction <br><br>
