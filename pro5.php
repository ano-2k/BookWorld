...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        "name" => "Fourth Wing (The Empyrean Book 1) Kindle Edition",
        "price" => 15.00,
        "quantity" => (int)$_POST['quantity'],
        "image" => "Images/pro-05.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>Fourth Wing - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-05.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>Fourth Wing (The Empyrean Book 1) Kindle Edition</h2>
                <h4>by Rebecca Yarros (Author) | Format: Kindle Edition</h4>
                <p><br>Book 1 of 3: The Empyrean<br>"Fourth Wing will have your heart pounding from beginning to end... A fantasy like you've never read before." ―#1 New York Times bestselling author Jennifer L. Armentrout</p>
                <h3>$15.00</h3>
                <form method="POST">
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-4">
                <a href="pro6.php"><img src="Images/pro-06.jpg"></a>
                <a href="pro6.php"><h4>Haunting Adeline</h4></a>
                <div class="fixed-star-rating">
                    <label for="star1"></label>
                    <label for="star2"></label>
                    <label for="star3"></label>
