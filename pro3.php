...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        ...
        "image" => "Images/pro-03.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>Teaching With AI - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-03.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>Teaching With AI</h2>
                <h4>by ModernMind Publications (Author) | Format: Kindle Edition</h4>
                <p><br>Are you ready to embrace AI and transform your teaching methods while saving significant time on planning?<br><br>"Teaching with AI" offers a straightforward, practical guide to using AI for educators and teachers, even if you're starting from scratch. Learn how to effectively implement AI in the classroom, preparing your students for a future shaped by technology.</p>
                <h3>$24.00</h3>
                <form method="POST">
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-4">
                <a href="pro5.php"><img src="Images/pro-05.jpg"></a>
                <a href="pro5.php"><h4>Fourth Wing</h4></a>
                <div class="fixed-star-rating">
                    <label for="star1"></label>
                    <label for="star2"></label>
                    <label for="star3"></label>
