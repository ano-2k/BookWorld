...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        "name" => "Onyx Storm (Deluxe Limited Edition) (The Empyrean, 3)",
        "price" => 19.00,
        "quantity" => (int)$_POST['quantity'],
        "image" => "Images/pro-11.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>Onyx Storm (Deluxe Limited Edition) - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-11.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>Onyx Storm (Deluxe Limited Edition) (The Empyrean, 3)</h2>
                <h4>by Rebecca Yarros (Author)</h4>
                <p><br>Book 3 of 3: The Empyrean<br>
                Preorder now and receive the stunning DELUXE LIMITED EDITION while supplies last―featuring gorgeous sprayed edges with stenciled artwork, as well as exclusive special design features.</p>
                <h3>$19.00</h3>
                <form method="POST">
