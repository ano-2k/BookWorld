...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        "name" => "In Five Years: A Novel",
        "price" => 24.00,
        "quantity" => (int)$_POST['quantity'],
        "image" => "Images/pro-07.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>In Five Years: A Novel - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-07.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>In Five Years: A Novel</h2>
                <h4>Rebecca Serle (Author), Megan Hilty (Narrator), Simon & Schuster Audio (Publisher)</h4>
                <p><br>A New York Times best seller.<br>Perfect for fans of Me Before You and One Day - a striking, powerful, and moving love story following an ambitious lawyer who experiences an astonishing vision that could change her life forever.</p>
                <h3>$24.00</h3>
                <form method="POST">
