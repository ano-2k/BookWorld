...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        ...
        "image" => "Images/pro-04.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>Age of Revolutions - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-04.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>Age of Revolutions</h2>
                <h4>by Fareed Zakaria (Author)</h4>
                <p><br>A New York Times Bestseller<br>The CNN host and best-selling author explores the revolutions―past and present―that define the polarized and unstable age in which we live.</p>
                <h3>$32.00</h3>
                <form method="POST">
