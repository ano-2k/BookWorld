...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        "name" => "Quantum Wealth: Mastering Brainwaves for Wealth and Wisdom",
        "price" => 12.00,
        "quantity" => (int)$_POST['quantity'],
        "image" => "Images/pro-09.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>Quantum Wealth: Mastering Brainwaves for Wealth and Wisdom - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-09.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>Quantum Wealth: Mastering Brainwaves for Wealth and Wisdom</h2>
                <h4>by Serenity Grey (Author)</h4>
                <p><br>Discover the Secrets of Prosperity and Inner Enlightenment<br>Embark on a profound journey into the depths of your own consciousness with "Quantum Wealth: Mastering Brainwaves for Wealth and Wisdom". This transformative book is your guide to understanding the intricate nexus between your mind’s potential and the manifestation of riches and sagacity. Delve into uncharted realms of thought, where wealth is not merely a dream but a tangible extension of your mental prowess.</p>
                <h3>$12.00</h3>
                <form method="POST">
