...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    $product = [
        "name" => "The Power of Being Rich: 10+ Essential Principles to Manifest What You Already Have",
        "price" => 13.00,
        "quantity" => (int)$_POST['quantity'],
        "image" => "Images/pro-12.jpg" // Update image URL if needed
    ];
...
<head>
    ...
    <title>The Power of Being Rich - BookWorld</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/pro-12.jpg" width="75%">
            </div>
            <div class="col-2">
                <h2>The Power of Being Rich: 10+ Essential Principles to Manifest What You Already Have</h2>
                <h4>by Roger L. Brooks (Author) | Format: Kindle Edition</h4>
                <p><br>Roger L. Brooks wrote "The Power of Being Rich" as a result of more than three decades of studying, practicing, and implementing universal law and the principles of positive thinking.</p>
                <h3>$13.00</h3>
                <form method="POST">
    ...
    <div class="small-container">
        <div class="row">
            <div class="col-4">
                ...
                <a href="pro9.php"><h4>The Four Agreements</h4></a>
            ...
            <div class="col-4">
                ...
                <a href="pro10.php"><h4>Quantum Wealth</h4></a>
                <div class="fixed-star-rating">
                    <label for="star1"></label>
                    <label for="star2"></label>
                    <label for="star3"></label>
            ...
            <div class="col-4">
                <a href="pro2.php"><img src="Images/pro-02.jpg"></a>
                <a href="pro2.php"><h4>The Women</h4></a>
                <div class="fixed-star-rating">
                    <label for="star1"></label>
                    <label for="star2"></label>
                    <label for="star3"></label>
